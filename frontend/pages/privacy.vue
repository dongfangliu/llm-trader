...
<template>
  <div style="min-height: 100dvh; background: var(--ios-bg);">
    ...
    <header style="display: flex; align-items: center; padding: 0 16px; height: 52px; position: sticky; top: 0; z-index: 100; background: rgba(249,249,249,0.94); backdrop-filter: blur(20px); border-bottom: 0.5px solid rgba(0,0,0,0.12);">
      ...
      <span style="font-size: 17px; font-weight: 600; color: var(--ios-label); flex: 1; text-align: center; margin-right: 40px;">隐私政策</span>
    </header>
    ...
    <div style="max-width: 680px; margin: 0 auto; padding: 24px 20px 60px;">
      ...
      <div style="background: white; border-radius: 16px; padding: 24px; margin-bottom: 12px;">
        <h2 style="font-size: 17px; font-weight: 700; color: var(--ios-label); margin: 0 0 14px;">一、收集的数据</h2>
      ...
      <!-- Section 2: 第三方服务 -->
      <div style="background: white; border-radius: 16px; padding: 24px; margin-bottom: 12px;">
        <h2 style="font-size: 17px; font-weight: 700; color: var(--ios-label); margin: 0 0 14px;">二、第三方服务</h2>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 0 0 14px;">
          本平台依赖以下第三方服务，您提交的分析请求内容可能传输至这些服务提供商：
        </p>
        <div style="display: flex; flex-direction: column; gap: 12px;">
          <div style="background: var(--ios-bg); border-radius: 12px; padding: 14px 16px;">
            <p style="font-size: 14px; font-weight: 600; color: var(--ios-label); margin: 0 0 4px;">LLM API（OpenAI / DeepSeek 等）</p>
          ...
          <div style="background: var(--ios-bg); border-radius: 12px; padding: 14px 16px;">
            <p style="font-size: 14px; font-weight: 600; color: var(--ios-label); margin: 0 0 4px;">爱发电（afdian.com）支付平台</p>
      ...
      <!-- Section 3: 存储与安全 -->
      <div style="background: white; border-radius: 16px; padding: 24px; margin-bottom: 12px;">
        <h2 style="font-size: 17px; font-weight: 700; color: var(--ios-label); margin: 0 0 14px;">三、存储与安全</h2>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 0 0 12px;">
      ...
      <!-- Section 4: Cookies -->
      <div style="background: white; border-radius: 16px; padding: 24px; margin-bottom: 12px;">
        <h2 style="font-size: 17px; font-weight: 700; color: var(--ios-label); margin: 0 0 14px;">四、Cookies 与本地存储</h2>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 0 0 12px;">
          本平台<strong>不使用任何第三方追踪 Cookie</strong>，不接入广告网络，不使用 Google Analytics 等外部分析服务。
        </p>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 0 0 12px;">
          我们仅使用浏览器的 <code style="background: var(--ios-bg); border-radius: 4px; padding: 1px 5px; font-size: 13px;">localStorage</code> 在您的设备本地存储以下信息：
        </p>
        <div style="display: flex; flex-direction: column; gap: 10px;">
          <div v-for="(item, i) in [
            ...
            <span style="width: 20px; height: 20px; border-radius: 50%; background: var(--ios-bg); display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; color: #3c3c43; flex-shrink: 0; margin-top: 1px;">{{ i + 1 }}</span>
            <p style="font-size: 14px; color: #3c3c43; line-height: 1.65; margin: 0;"><code style="background: var(--ios-bg); border-radius: 4px; padding: 1px 5px; font-size: 13px;">{{ item.k }}</code>：{{ item.v }}</p>
          </div>
        </div>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 14px 0 0;">
      ...
      <!-- Section 5: 用户权利 -->
      <div style="background: white; border-radius: 16px; padding: 24px; margin-bottom: 12px;">
        <h2 style="font-size: 17px; font-weight: 700; color: var(--ios-label); margin: 0 0 14px;">五、您的权利</h2>
        <p style="font-size: 14px; color: #3c3c43; line-height: 1.75; margin: 0 0 14px;">
          您可以随时对自己的数据行使以下权利：
        </p>
        <div style="display: flex; flex-direction: column; gap: 12px;">
          <div style="background: var(--ios-bg); border-radius: 12px; padding: 14px 16px;">
            <p style="font-size: 14px; font-weight: 600; color: var(--ios-label); margin: 0 0 4px;">删除本地数据</p>
          ...
          <div style="background: var(--ios-bg); border-radius: 12px; padding: 14px 16px;">
            <p style="font-size: 14px; font-weight: 600; color: var(--ios-label); margin: 0 0 4px;">删除服务器数据</p>
          ...
          <div style="background: var(--ios-bg); border-radius: 12px; padding: 14px 16px;">
            <p style="font-size: 14px; font-weight: 600; color: var(--ios-label); margin: 0 0 4px;">访问与更正</p>
